...
class Tx_PtExtlist_Utility_ExternalPlugin {
	...
	public static function getDataBackend($listIdentifier) {
		...
		if($extListBackend == NULL) {
			...
			$configurationBuilderFactory = GeneralUtility::makeInstance('Tx_Extbase_Object_ObjectManager')->get('Tx_PtExtlist_Domain_Configuration_ConfigurationBuilderFactory'); /* @var $configurationBuilderFactory Tx_PtExtlist_Domain_Configuration_ConfigurationBuilderFactory */
	...
	public static function getListByDataBackend(Tx_PtExtlist_Domain_DataBackend_DataBackendInterface $dataBackend) {
		return GeneralUtility::makeInstance('Tx_Extbase_Object_ObjectManager')
	...
	protected static function loadLifeCycleManager() {
		...
		$objectManager = GeneralUtility::makeInstance('Tx_Extbase_Object_ObjectManager'); /* @var $objectManager Tx_Extbase_Object_ObjectManager */
