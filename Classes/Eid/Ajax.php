...
$TSFE = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance((\TYPO3\CMS\Frontend\Controller\TypoScriptFrontendController::class), $TYPO3_CONF_VARS, 0, 0); /* @var $TSFE \TYPO3\CMS\Frontend\Controller\TypoScriptFrontendController */
$TSFE->config['config'] = [];
...
$tsParser = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance((\TYPO3\CMS\Core\TypoScript\Parser\TypoScriptParser::class)); /* @var $tsParser \TYPO3\CMS\Core\TypoScript\Parser\TypoScriptParser */
...
$dispatcher = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_PtExtbase_Utility_AjaxDispatcher::class); /* @var $dispatcher Tx_PtExtbase_Utility_AjaxDispatcher */
