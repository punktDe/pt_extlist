 ...
 * @entity
 */
class Tx_PtExtlist_Domain_Model_Bookmarks_BookmarkStrategy implements Tx_PtExtlist_Domain_Model_Bookmarks_BookmarkStrategyInterface {
	 ...
	 */
	public function mergeSessionAndBookmark(Tx_PtExtlist_Domain_Model_Bookmarks_Bookmark $bookmark, array $sessionData){
	 ...
	 * @return void
	 */
	public function addContentToBookmark(Tx_PtExtlist_Domain_Model_Bookmarks_Bookmark $bookmark, Tx_PtExtlist_Domain_Configuration_ConfigurationBuilder $configurationBuilder, array $sessionData) {
