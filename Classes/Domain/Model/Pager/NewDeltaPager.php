 ...
 * @see Tx_PtExtlist_Tests_Domain_Model_Pager_NewDeltaPagerTest
 */
class Tx_PtExtlist_Domain_Model_Pager_NewDeltaPager extends Tx_PtExtlist_Domain_Model_Pager_DefaultPager {
	...
	protected function mergeBlocks($block1, $block2, $block3) {
		...
		foreach($block1 as $key => $value) {
			if (0 < $key && $key <= $this->getPageCount()) $merged[$key] = intval($value);
		}
