...
class Tx_PtExtlist_Domain_StateAdapter_Storage_DBStorageAdapter implements Tx_PtExtbase_State_Session_Storage_AdapterInterface
{
    ...
    {
        $this->cacheTag = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance((\TYPO3\CMS\Extbase\Object\ObjectManager::class))->get(\Tx_PtExtlist_Extbase_ExtbaseContext::class)->getExtensionName();
    }
