 ...
 */
class PagerConfigCollection extends ObjectCollection
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $restrictedClassName = PagerConfig::class;
     ...
     */
    public function addPagerConfig(PagerConfig $pagerConfig, $pagerIdentifier)
    {
