...
class Tx_PtExtlist_Tests_ExtlistContext_ExtlistContextTest extends Tx_PtExtlist_Tests_BaseTestcase
{
    ...
    public function setFilterValueSetsFilterValueAsExpectedRebuildsListCacheIfParameterIsSet()
    {
        ...
        $extlistContextMock = $this->getMock('Tx_PtExtlist_ExtlistContext_ExtlistContext', ['getFilterByFullFiltername', 'getList'], [], '', false);
    ...
    {
        $filterMock = $this->getMock('Tx_PtExtlist_Domain_Model_Filter_StringFilter', ['setFilterValue', 'initGenericFilterByTSConfig', 'init'], [], '', false);
