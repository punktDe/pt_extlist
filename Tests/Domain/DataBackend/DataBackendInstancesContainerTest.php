...
class Tx_PtExtlist_Tests_Domain_DataBackend_DataBackendInstancesContainerTest extends Tx_PtExtlist_Tests_BaseTestcase
{
    ...
    {
        $instancesContainer1 = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_PtExtlist_Domain_DataBackend_DataBackendInstancesContainer::class);
        $instancesContainer2 = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_PtExtlist_Domain_DataBackend_DataBackendInstancesContainer::class);
