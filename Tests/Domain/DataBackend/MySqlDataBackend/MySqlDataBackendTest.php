...
GROUP BY company
	...
	protected function getDataBackend($configurationBuilderMock = NULL) {
		...
		$dataBackend->injectRendererChainFactory(\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('Tx_Extbase_Object_ObjectManager')->get('Tx_PtExtlist_Domain_Renderer_RendererChainFactory'));
