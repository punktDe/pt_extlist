...
GROUP BY company 
	...
	protected function getDataBackend($configurationBuilderMock = NULL) {
		...
		$dataBackend->injectRendererChainFactory(t3lib_div::makeInstance('Tx_Extbase_Object_ObjectManager')->getObject('Tx_PtExtlist_Domain_Renderer_RendererChainFactory'));
