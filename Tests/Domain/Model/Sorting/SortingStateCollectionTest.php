...
class Tx_PtExtlist_Tests_Domain_Model_Sorting_SortingStateCollectionTest extends Tx_PtExtlist_Tests_BaseTestcase
{
    ...
    {
        $this->assertTrue(class_exists(\Tx_PtExtlist_Domain_Model_Sorting_SortingStateCollection::class));
    }
    ...
    public function getIstanceBySessionArrayReturnsCorrectSortingStateCollection()
    {
        ...
        $fieldConfigurationMock1 = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $fieldConfigurationMock1->expects($this->any())->method('getIdentifier')->will($this->returnValue('field1'));
        $fieldConfigurationMock2 = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $fieldConfigurationMock2->expects($this->any())->method('getIdentifier')->will($this->returnValue('field2'));
        $fieldsConfigurationMock = $this->getMock('Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfigCollection', ['getFieldConfigByIdentifier'], [], '', false);
        ...
        $configurationBuilderMock = $this->getMock('Tx_PtExtlist_Domain_Configuration_ConfigurationBuilder', ['buildFieldsConfiguration'], [], '', false);
    ...
    {
        $sortingStateCollectionMock = $this->getMock($this->buildAccessibleProxy(\Tx_PtExtlist_Domain_Model_Sorting_SortingStateCollection::class), ['dummy'], [], '', false); /** @var  $sortingStateCollectionMock Tx_PtExtlist_Domain_Model_Sorting_SortingStateCollection */
        $fieldConfigurationMock = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $fieldConfigurationMock->expects($this->any())->method('getIdentifier')->will($this->returnValue('field1'));
        $sortingStateMock = $this->getMock('Tx_PtExtlist_Domain_Model_Sorting_SortingState', ['getField', 'getDirection'], [], '', false);
    ...
    {
        $sortingStateCollectionMock = $this->getMock($this->buildAccessibleProxy(\Tx_PtExtlist_Domain_Model_Sorting_SortingStateCollection::class), ['dummy'], [], '', false);
        $fieldConfigurationMock = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $fieldConfigurationMock->expects($this->any())->method('getIdentifier')->will($this->returnValue('field1'));
    ...
    public function getSortedFieldsReturnsCorrectArrayOfSortedFields()
    {
        $fieldConfigurationMock1 = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $fieldConfigurationMock2 = $this->getMock(Tx_PtExtlist_Domain_Configuration_Data_Fields_FieldConfig, ['getIdentifier'], [], '', false);
        $sortingStateMock1 = $this->getMock('Tx_PtExtlist_Domain_Model_Sorting_SortingState', ['getField', 'getDirection'], [], '', false);
        ...
        $sortingStateMock2 = $this->getMock('Tx_PtExtlist_Domain_Model_Sorting_SortingState', ['getField', 'getDirection'], [], '', false);
