 ...
 * @see Tx_PtExtlist_Domain_Model_Filter_ProxyFilter
 */
class Tx_PtExtlist_Tests_Domain_Model_Filter_ProxyFilterTest extends Tx_PtExtlist_Tests_BaseTestcase
{
    ...
    protected function buildAccessibleProxyFilter()
    {
        ...
        $proxyFilterMock->injectConfigurationBuilderFactory($this->objectManager->get(\Tx_PtExtlist_Domain_Configuration_ConfigurationBuilderFactory::class));
        $filterFactory = $this->objectManager->get(\Tx_PtExtlist_Domain_Model_Filter_FilterFactory::class);
