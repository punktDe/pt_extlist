...
class Tx_PtExtlist_Tests_Domain_Model_Pager_PagerCollectionTest extends Tx_PtExtlist_Tests_BaseTestcase
{
    ...
    {
        $collection = new PagerCollection($this->configurationBuilderMock);

        $pager = $this->getMock('DefaultPager', ['setCurrentPage'], [], '', false, false, true);
    ...
    {
        $collection = new PagerCollection($this->configurationBuilderMock);
        $pager = $this->getMock('DefaultPager', ['setCurrentPage', 'getItemCount', 'getLastPage'], [], '', false, false);
