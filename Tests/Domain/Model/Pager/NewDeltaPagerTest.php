 ...
 * @see Tx_PtExtlist_Domain_Model_Pager_NewDeltaPager
 */
class Tx_PtExtlist_Tests_Domain_Model_Pager_NewDeltaPagerTest extends Tx_PtExtlist_Tests_BaseTestcase {

	/**
	 * Holds an instance of pager object
	 *
	 * @var Tx_PtExtlist_Domain_Model_Pager_NewDeltaPager
	 */
	protected $pager;
	...
	public function setup() {
		...
		$proxyClass = $this->buildAccessibleProxy('Tx_PtExtlist_Domain_Model_Pager_NewDeltaPager');
